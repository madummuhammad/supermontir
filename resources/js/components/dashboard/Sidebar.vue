    ...
    <div class="w-1/4 hidden md:block">
                    ...
                    >
                      <ul>
                        ...
                        >
                          <Link href="/user/profile" class="flex items-center nav-link">
                             <i
                                  class="fa-solid fa-clock-rotate-left fa-lg mr-2 p-1 bg-orange-500 rounded-full w-[30px] h-[30px] flex items-center justify-center"
                                >
                        ...
                        <li class="w-full p-4 border-gray-200 flex items-center">
                          <Link href="/user/garage"
                            ...
                            class="flex items-center nav-link"
                            onclick="loadPage('garasi')"
                          >
                            <i
                              class="fa-solid fa-warehouse fa-lg mr-2 p-1 bg-orange-500 rounded-full w-[30px] h-[30px] flex items-center justify-center"
                            >
                        ...
                        <li class="w-full p-4 border-gray-200 flex items-center">
                          <a
                            href="#"
                            class="flex items-center nav-link"
                            onclick="loadPage('point')"
                          >
                            <i
                              class="fa-solid fa-gift fa-lg mr-2 p-1 bg-orange-500 rounded-full w-[30px] h-[30px] flex items-center justify-center"
                            >
                        ...
                        <li class="w-full p-4 border-gray-200 flex items-center">
                          <a
                            href="#"
                            class="flex items-center nav-link"
                            onclick="loadPage('kupon')"
                          >
                            <i
                              class="fa-solid fa-ticket-simple fa-lg mr-2 p-1 bg-orange-500 rounded-full w-[30px] h-[30px] flex items-center justify-center"
                            >
                        ...
                        <li class="w-full p-4 border-gray-200 flex items-center">
                          <a
                            href="#"
                            class="flex items-center nav-link"
                            onclick="loadPage('notifikasi')"
                          >
                            <i
                              class="fa-solid fa-bell fa-lg mr-2 p-1 bg-orange-500 rounded-full w-[30px] h-[30px] flex items-center justify-center"
                            >
                        ...
                        <li class="w-full p-4 border-gray-200 flex items-center">
                          <a href="#" class="flex items-center nav-link">
                            <i
                              class="fa-solid fa-right-from-bracket fa-lg mr-2 p-1 bg-orange-500 rounded-full w-[30px] h-[30px] flex items-center justify-center"
                            >
